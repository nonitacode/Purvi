...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","ofline_king")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","Aaradhya_musicbot")
# --------------------------------------------------------
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ofline_king")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ofline_king")
